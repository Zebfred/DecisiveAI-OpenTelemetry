...
class RecommendationService(demo_pb2_grpc.RecommendationServiceServicer):
    def ListRecommendations(self, request, context):
        ...
        print("LOGGERERDANSDKJNABSKJDBASJHDBAJHSDB")
...
def get_product_list(request_product_ids):
    ...
    global cached_ids
    print()
    print("AKSJDBKJASBDJHKASBDJAHSDBJHASBDJHABD")
    print()
    import pdb; pdb.set_trace()
...
if __name__ == "__main__":
    ...
    logger.info(f"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!{meter}")
    logger.info(f"22222233333333333333333333333333333333333333333333333333{metrics}")
    import pdb;
    pdb.set_trace()
    # Start server
